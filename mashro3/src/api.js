...
export const getCars = (userId) => API.get(`/cars/${userId}`);
...
export const getRepairShops = () => API.get("/repair-shops");

export const getCareCenters = () => API.get("/care-centers");

export const getCategories = () => API.get("/categories");

export const getCarCareImages = () => API.get("/car-care-images");

export const getGasStationsFromDB = () => API.get("/gas-stations-db");
